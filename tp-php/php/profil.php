...
<div class="profil"><?php
    ...
    <header>
        ...
        <div class="welcome">
            ...
            <span>Dernière connexion le <?php echo date( 'N/M/Y à H:i:s', strtotime($user['last_login']));?></span>
    ...
    <div id="popup">
        <form action="profil.php" method="POST" enctype="multipart/form-data">
            ...
            <label for="avatar">Avatar:
                <input type="file" name="avatar" id="avatar" value="<?php echo $user['avatar']; ?>"/>
            </label>
...
function fetch_user($id){
    ...
    try{
        $bdd = new PDO('mysql:host=localhost;dbname=tp-php;charset=utf8', 'root', 'rootmos');
    }
    catch (Exception $e)
    {
    ...
    $req = $bdd->prepare('SELECT * FROM user WHERE id = ?'); /* INNER JOIN team ON user.id_team = team.id*/
